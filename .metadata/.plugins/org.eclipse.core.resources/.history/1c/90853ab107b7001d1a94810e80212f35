...
import com.control.veterinaria.rest_controller.interfaces.ColaboradorRestController;
import com.control.veterinaria.service.interfaces.ColaboradorService;

@RestController
@RequestMapping("/api/colaborador")
public class ColaboradorRestControllerImp implements ColaboradorRestController {
